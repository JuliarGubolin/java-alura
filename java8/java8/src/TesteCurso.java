...
public class TesteCurso {
    public static void main(String[] args) {
        ...
        //Stream: devolve um conjunto de objetos. Não impacta na collection original
        ...
        List<Curso> cursosComMaisDe100Alunos = cursos.stream().filter(c -> c.getAlunos() > 100).collect(Collectors.toList());
        cursos
        .stream()
